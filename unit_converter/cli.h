...
void def(std::string key, std::string opt="") {
   ...
   else if(key == "unav") std::cout<<"\033[91m\033[1mUnavailable option: '"<<opt<<"'\033[0m\n\n";
   else if(key == "exit") {
      std::cout<<"\033[91m\033[1mExit Program...\033[0m\n\n";
      exit(0);
   }
   else std::cout<<"\033[91m\033[1mInvlaid key '"<<key<<"'\033[0m\n\n";
}
